...
namespace CastAjansCore.DataLayer.Migrations
{
    ...
    [Migration("20190605110851_oyuncuresimleriDefault")]
    partial class oyuncuresimleriDefault
    {
            ...
            modelBuilder.Entity("CastAjansCore.Entity.Kisi", b =>
                {
                    ...
                    b.HasIndex("EkleyenId")
                        .IsUnique()
                        .HasFilter("[EkleyenId] IS NOT NULL");
            ...
            modelBuilder.Entity("CastAjansCore.Entity.Kisi", b =>
                {
                    b.HasOne("CastAjansCore.Entity.Kisi", "Ekleyen")
                        .WithOne()
                        .HasForeignKey("CastAjansCore.Entity.Kisi", "EkleyenId");
